...
This package uses the Node utility https://github.com/svg/svgo[SVGO] to optimize SVG files. It provides a command and a minor mode (that activates the key binding `C-c o`) to optimize the SVG contens of the current buffer.
